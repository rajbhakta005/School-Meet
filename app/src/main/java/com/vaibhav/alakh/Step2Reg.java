...
public class Step2Reg extends AppCompatActivity {
    ...
    // LogCat tag
    private static final String TAG = Step2Reg.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.step2_member_image_view_reg);
        ...
        mobiletv = findViewById(R.id.step2_mobile_tv_reg);
        mobiletv.setText(mobile);

        referredTV = findViewById(R.id.referralTV);

        nameET = findViewById(R.id.step2_name_et_reg);
        addressET = findViewById(R.id.step2_address_et_reg);
        cityET = findViewById(R.id.step2_city_et_reg);
        //wardET = findViewById(R.id.step2_ward_et);
        //assemblyET = findViewById(R.id.step2_assembly_et);
        occupationET = findViewById(R.id.step2_occupation_et_reg);

        nameFAB = findViewById(R.id.fab_step2_name_reg);
        addressFAB = findViewById(R.id.fab_step2_address_reg);
        wardFAB = findViewById(R.id.fab_step2_ward_reg);
        occupationFAB = findViewById(R.id.fab_step2_occupation_reg);
//        pgpFAB = findViewById(R.id.fab_step2_pgp_reg);
//        asangathitFAB = findViewById(R.id.fab_step2_asangathit_reg);
//        //asangathitSkipFAB = findViewById(R.id.fab_step2_asangathit_skip);
//        entrepreneurshipFAB = findViewById(R.id.fab_step2_entrepreneurship_reg);
//        entrepreneurshipSkipFAB = findViewById(R.id.fab_step2_entrepreneurship_skip_reg);
//        secondLastFAB = findViewById(R.id.fab_step2_secondlast_reg);
//        secondLastSkipFAB = findViewById(R.id.fab_step2_secondlast_skip_reg);
//        lastFAB = findViewById(R.id.fab_step2_last_reg);
        submitFAB = findViewById(R.id.fab_step2_final_submit_reg);

        addressBackButton = findViewById(R.id.fab_step2_address_back_reg);


        nameCV = findViewById(R.id.step2_name_card_view_reg);
        addressCV = findViewById(R.id.step2_address_card_view_reg);
        wardCV = findViewById(R.id.step2_assembly_card_view_reg);
        occupationCV = findViewById(R.id.step2_occuption_card_view_reg);
//        pgpCV = findViewById(R.id.step2_pgp_options_card_reg);
//        asangathitConditionCV = findViewById(R.id.step2_asangathit_condition_card_view_reg);
//        asangathitCV = findViewById(R.id.step2_asangathit_options_card_reg);
//        entrepreneurshipCV = findViewById(R.id.step2_entrepreneurship_options_card_reg);
//        secondLastCV = findViewById(R.id.step2_second_last_options_card_reg);
//        lastCV = findViewById(R.id.step2_last_options_card_reg);

        progressBar = findViewById(R.id.step2_progress_bar_reg);
        txtPercentage = findViewById(R.id.step2_text_percentage_reg);

        sp1 = findViewById(R.id.spinner1_reg);
        sp2 = findViewById(R.id.spinner2_reg);


        occ_op1 = findViewById(R.id.occupation_op1_reg);
        occ_op2 = findViewById(R.id.occupation_op2_reg);
        occ_op3 = findViewById(R.id.occupation_op3_reg);
        occ_op4 = findViewById(R.id.occupation_op4_reg);
        occ_op5 = findViewById(R.id.occupation_op5_reg);
        occ_op6 = findViewById(R.id.occupation_op6_reg);
        occ_op7 = findViewById(R.id.occupation_op7_reg);
        occ_op8 = findViewById(R.id.occupation_op8_reg);
        occ_op9 = findViewById(R.id.occupation_op9_reg);
        occ_op10 = findViewById(R.id.occupation_op10_reg);
        occ_op11 = findViewById(R.id.occupation_op11_reg);
        occ_op12 = findViewById(R.id.occupation_op12_reg);

//        pgp_op1 = findViewById(R.id.step2_pgp_op1_reg);
//        pgp_op2 = findViewById(R.id.step2_pgp_op2_reg);
//        pgp_op3 = findViewById(R.id.step2_pgp_op3_reg);
//        pgp_op4 = findViewById(R.id.step2_pgp_op4_reg);
//        pgp_op5 = findViewById(R.id.step2_pgp_op5_reg);
//        pgp_op6 = findViewById(R.id.step2_pgp_op6_reg);
//        pgp_op7 = findViewById(R.id.step2_pgp_op7_reg);
//
//
//        asang_cond1 = findViewById(R.id.asangathit_condition_op1_reg);
//        asang_cond2 = findViewById(R.id.asangathit_condition_op2_reg);
//        //Radio Group for PGP Options
//        //selectGrouptwo = findViewById(R.id.step2_radio_group_two);
//
//        selectGroupfour = findViewById(R.id.step2_radio_group_four_reg);
//
//        //Asangathit Union
//        selectGroupfive = findViewById(R.id.step2_radio_group_five_reg);
//
//        //Second Last
//        selectGroupsix = findViewById(R.id.step2_radio_group_six_reg);
//
//        //Last
//        selectGroupseven = findViewById(R.id.step2_radio_group_seven_reg);
//
//        asangathitCheckBox = findViewById(R.id.step2_asangathit_checkbox_reg);
//        entrepreneurshipCheckBox = findViewById(R.id.step2_entrepreneurship_checkbox_reg);

        backButton = findViewById(R.id.step2_back_button_image_reg);
...
//        spin.setAdapter(aa);
        ...
        sp1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (s1.contentEquals("Ajmer")) {
                    Toast.makeText(Step2Reg.this, s1, Toast.LENGTH_SHORT).show();
                    assembly = s1;
                    ...
                    list.add("Nasirabad");
                    list.add("Pushkar");
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(Step2Reg.this,
        ...
        occ_op1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                referredTV.setVisibility(View.VISIBLE);
...
//                    Toast.makeText(Step2Reg.this, "कृपया एक विकल्प चुनें", Toast.LENGTH_SHORT).show();
//                } else {
//
...
//        });
    ...
    private boolean validateReferal() {
        if (referredTV.getText().toString().trim().isEmpty()) {
            String errorString = "वैध ID दर्ज करें।";  // your error message
            ForegroundColorSpan foregroundColorSpan = new ForegroundColorSpan(errorColor);
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(errorString);
            spannableStringBuilder.setSpan(foregroundColorSpan, 0, errorString.length(), 0);
            referredTV.setError(spannableStringBuilder);
            return (false);
...
//                String email = sharedPreferences.getString(Config.EMAIL_SHARED_PREF,"Not Available");
                ...
                //SharedPreferences sharedPreferences = getSharedPreferences(Config.SHARED_PREF_NAME, Context.MODE_PRIVATE);
                referred_by = referredTV.getText().toString().trim();
        ...
        builder.setMessage(message)
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        finishActivity(0);
                        Intent intent = new Intent(Step2Reg.this, Home.class);
