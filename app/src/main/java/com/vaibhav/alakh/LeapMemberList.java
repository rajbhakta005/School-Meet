...
public class LeapMemberList extends AppCompatActivity {

    List<GetDataAdapterListLeap> GetDataAdapter1;
    ...
    String GET_JSON_DATA_HTTP_URL_V = "https://seekho.xyz/pgp-android/api/list-leap-accounts.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leap_member_list);
        ...
        shimmerFrameLayout = findViewById(R.id.list_shimmer_layout);
        linearLayout = findViewById(R.id.leap_listLL);
        ...
        adminWhatsapp = findViewById(R.id.list_whatsapp);

        adminWhatsapp.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array){
        ...
        for(int i = 0; i<array.length(); i++) {
            ...
            GetDataAdapterListLeap GetDataAdapter2 = new GetDataAdapterListLeap();
        ...
        recyclerViewadapter = new RecyclerViewAdapterListLeap(GetDataAdapter1, this);
